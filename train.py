...
def config_mlflow():
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'diego.ghion'
    os.environ['MLFLOW_TRACKING_PASSWORD'] = 'brT3st&2020_'
    mlflow.set_tracking_uri('https://dagshub.com/diego.ghion/mlops-ead.mlflow')
